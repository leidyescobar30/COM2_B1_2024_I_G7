...
class python_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._offset_range = Range(0, 10, 1, 0, 200)
        ...
        self._freq_range = Range(1000, 1e6, 1, 1000, 200)
        ...
        self.blocks_vector_source_x_0 = blocks.vector_source_f((2, 0, 1), True, 1, [])
        ...
        self._A_range = Range(0, 10, 0.5, 2, 200)
        ...
        # Connections
        ##################################################
        self.connect((self.blocks_vector_source_x_0, 0), (self.CalculoPotenciaComunicaciones_0, 0))
